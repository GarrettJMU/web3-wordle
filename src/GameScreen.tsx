...
import {StyleSheet, Text, View, Clipboard, Platform, Animated} from 'react-native';
...
import {createTree, verifyLeaf} from "./merkleUtils";
import {ALLOWED_ADDRESSES} from "./constants/gameConstants";
...
const GameScreen = () => {
    ...
    useEffect(() => {
        if (address) {
            const tree = createTree(ALLOWED_ADDRESSES)
            const allowed = verifyLeaf(tree, address)
        ...
        return (
            <View style={styles.center}>
                <Text style={[styles.textWhite, styles.mb12]}>
                    Address is not allowed to play this game.
                </Text>
            </View>
        )
    }
